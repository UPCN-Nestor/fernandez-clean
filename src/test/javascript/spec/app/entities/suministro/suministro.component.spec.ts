...
import { SuministroComponent } from 'app/entities/suministro/suministro.component';
...
describe('Component Tests', () => {
  describe('Suministro Management Component', () => {
    let comp: SuministroComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SuministroComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.suministros && comp.suministros[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
